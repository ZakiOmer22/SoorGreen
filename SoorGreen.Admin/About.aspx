...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        /* Light mode specific colors for About page */
        [data-theme="light"] {
            --light-bg: #f8f9fa;
            --light-card: #ffffff;
            --light-border: #e9ecef;
            ...
            [data-theme="light"] .about-hero-image::before {
            ...
            /* Mission & Vision Cards Light Mode */
            ...
            /* Milestones Light Mode */
            [data-theme="light"] .milestone-item h6 {
                color: var(--light-text) !important;
            }

            [data-theme="light"] .milestone-item p {
                color: var(--light-muted) !important;
            }
            ...
            /* Partner Logos Light Mode */
            [data-theme="light"] .partner-logo i {
                color: var(--primary);
            }

            [data-theme="light"] .partner-logo:hover i {
                transform: scale(1.2);
            }

            /* Impact Section Light Mode - Keep gradient but adjust text */
        ...
        /* Remove old minimal light mode styles and keep only the comprehensive ones above */

...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .text-primary { color: #00d4aa !important; }
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center">
                    <div class="register-hero-visual">
                        <div class="register-hero-image rounded-3 shadow-lg" style="background: linear-gradient(45deg, #00d4aa, #0077b6); height: 400px; width: 100%;"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="role-card" data-role="ADMN">
                        ...
                        <div class="role-features text-start">
                            <div class="d-flex align-items-center mb-2">
                                <i class="fas fa-check text-warning me-2 small"></i>
            ...
            <div class="row mt-5">
                <div class="col-lg-6 mx-auto text-center">
                    <asp:Button ID="btnContinue" runat="server" Text="Continue to Registration" 
                        ...
                        Enabled="false" />
                    <p class="small mt-3">Select a role above to continue with registration</p>
                </div>
            </div>
        </div>
    </section>
